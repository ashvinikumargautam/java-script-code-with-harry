...
export function generatePDF(options) {
    return new Promise((resolve, reject) => {
        void (async () => {
            ...
            let html;
            try {
                html = await compileTemplate(options.html, options.data, engine, useCache);
            }
            catch (error) {
 ...
 */
async function compileTemplate(template, data, engine = 'handlebars', useCache = true) {
    ...
    switch (engine) {
        case 'ejs': {
            try {
                ...
                compiled = async (data) => await templateFn(data);
            }
            catch (error) {
        ...
        default: {
            ...
            compiled = (templateData) => Promise.resolve(handlebarsTemplate(templateData));
            break;
        }
    }
